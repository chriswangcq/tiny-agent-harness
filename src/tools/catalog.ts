...
export const BASH_TOOL_DEFINITION: ToolDefinition = {
  ...
  description:
    ...
    "This is a pure PTY interface: write_text writes exact bytes to the terminal and never appends Enter for you; include \\n explicitly or use key enter. All write_text input is protected-paced by the runtime at about 128 bytes per chunk with a small delay so interactive bash can keep up. " +
