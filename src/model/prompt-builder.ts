...
const SYSTEM_MESSAGE =
  ...
  "- Do not pass large JSON, code, Markdown, or reply bodies as one huge shell argument. Use stdin forms such as `command --json - <<'JSON' ... JSON`, quoted heredocs, or input redirection.\n" +
