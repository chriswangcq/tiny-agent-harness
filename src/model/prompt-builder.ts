...
const SYSTEM_MESSAGE =
  ...
  "  For short single-line IM replies with safe shell text, run `node dist/cli/main.js im send --channel <channel> --kind status --text '<reply>'\\n` through write_text. For any reply containing newlines, quotes, backticks, pipes, or dollars, use the stdin consumer flow instead.\n" +
  "  There is no file staging protocol, frame protocol, or separate payload tool in the model-visible action surface.\n" +
